  ...
  return measurements.map((m, index) => `
    <tr>
      ...
      <td style="padding: 8px; border: 1px solid #ddd; text-align: center;">
        ${m.parts === 'One Part' ? `<span style='display:inline-block;border:2px solid #2563eb;border-radius:999px;padding:2px 8px;color:#2563eb;font-weight:bold;'>${m.pieces?.toFixed(1)}</span>` : `${m.pieces?.toFixed(1)} pieces`}
      </td>
